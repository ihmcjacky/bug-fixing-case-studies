...
export default function AtpcRangeSlider(props) {
    const {
        min, max,
        showLevelLabel, enableRailColor, enable,
        value, thumbStyle, trackStyle, labelStyle, disableScroll, step, t
    } = props;
                    ...
                    typeof data[2] !== 'undefined' ? (
                        <Typography
                            style={{
                                ...
                                position: 'absolute',
                                width: '40px',
                                left: `${((((data[2] - max)) / (max - min)) * 100) + 100}%`,
                                marginLeft: '-20px',
                                userSelect: 'none',
                            }}
                        >
                            ...
                            <span
                                style={{
                                    // marginLeft: '5px',
                                    marginTop: Math.abs(data[0]) - Math.abs(data[2]) < 5 ? '15px' : '0px',
                                }}
                            >
                                {t('upper')}
                            </span>
